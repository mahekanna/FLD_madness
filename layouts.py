# -*- coding: utf-8 -*-
"""
Created on Thu Mar 27 16:59:32 2025

@author: mahes
"""

"""
Page layouts for the Fibonacci Cycle Web Application
"""
import dash
...
dashboard_layout = html.Div([
    ...
    # Refresh interval for dashboard updates
    dcc.Interval(
        id="refresh-interval",
...
settings_layout = html.Div([
    ...
    dbc.Tabs([
                ...
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            ...
                            dbc.InputGroup([
                                dbc.Input(id="min-period", type="number", value="20", className="mb-2"),
                                dbc.InputGroupText("to"),
                                dbc.Input(id="max-period", type="number", value="250", className="mb-2"),
                            ]),
                            html.Small("Range of cycle periods to detect", className="text-muted d-block mb-3"),
                        ], width=6),
                        dbc.Col([
                            html.Label("Fibonacci Cycle List"),
                            dbc.Input(id="fib-cycles", value="20,21,34,55,89", className="mb-2"),
        ...
        dbc.Tab([
            dbc.Card(
                dbc.CardBody([
                    html.H4("Storage Settings", className="card-title mb-3"),
                    
                    # Google Drive Configuration
                    dbc.Row([
                        dbc.Col([
                            html.Label("Google Drive Storage Path"),
                            dbc.Input(id="drive-path", value="G:\\My Drive\\FLD-FIB-CYCLE", className="mb-2"),
                            html.Small("Base path on Google Drive for storing data and reports", className="text-muted d-block mb-3"),
                        ], width=12),
                    ]),
                    ...
                    dbc.Row([
                        dbc.Col([
                            html.Label("Storage Options"),
                            dbc.Checklist(
                                id="storage-options",
                                options=[
                                    {"label": "Save reports to Google Drive", "value": "save_reports"},
                                    {"label": "Save logs to Google Drive", "value": "save_logs"},
                                    {"label": "Save charts to Google Drive", "value": "save_charts"},
                                    {"label": "Use Google Drive for data cache", "value": "use_drive_cache"},
                                    {"label": "Create daily folders for reports", "value": "daily_folders"},
                                ],
                                value=["save_reports", "save_logs", "save_charts"],
                                className="mb-3",
                            ),
                        ], width=12),
                    ]),
                    
                    dbc.Button("Save Storage Settings", id="save-storage-settings", color="primary"),
                    html.Div(id="storage-settings-status", className="mt-2"),
                    
                    # Current Drive Status
                    dbc.Alert(
                        [
                            html.H5("Google Drive Status", className="alert-heading"),
                            html.P(id="drive-status-text", children="Checking Google Drive status..."),
                            html.Hr(),
                            html.P("Google Drive integration allows you to access your data across devices.", className="mb-0")
                        ],
                        id="drive-status-alert",
                        color="info",
                        className="mt-3"
                    ),
                    
                    # Test Drive Connection
                    dbc.Button("Test Drive Connection", id="test-drive-connection", color="info", className="mt-2"),
                    html.Div(id="drive-connection-status", className="mt-2"),
                ]),
            ),
        ], label="Storage", tab_id="storage-settings"),        
        dbc.Tab([
            dbc.Card(
                dbc.CardBody([
